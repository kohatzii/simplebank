...
migrateup:
	migrate -path . -database "postgresql://tsakalos:secret@localhost:5432/simple_bank?sslmode=disable" -verbose up

migratedown:
	migrate -path . -database "postgresql://tsakalos:secret@localhost:5432/simple_bank?sslmode=disable" -verbose down
